...
class  Schoolhonor extends Component {
  render() {
    return (
     <div className="page">	
		 <Nav NavTitle="nav noborder" back={this.props} backto="/news/microweb" NavLeft="fa fa-chevron-left" NavName="学校荣誉">
            <div className="icon"></div>
        </Nav>
			<p className="margin70"></p>			
			<div className="content">			
				<Link to="/HonorDetail" className="submod">
				<div className="cell">	
