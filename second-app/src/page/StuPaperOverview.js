...
class StuPaperOverview extends Component {
    constructor(){
        super()
  ...
  render() {
    return (
        <div className="page">
        <Nav NavTitle="nav border clickeye" backhistory={this.backhistory} NavLeft="fa fa-chevron-left" NavName="学生试卷总览">
        ...
        <p>&nbsp;</p>
        <Link to="/testdetail2" className="confirmbtn">
...
export default StuPaperOverview;