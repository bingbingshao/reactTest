...
class JoinExam extends Component {
  render() {
    return (
        <div className="page">
        <Nav NavTitle="nav border" back={this.props} backto="/studentmenu" NavLeft="fa fa-chevron-left" NavName="已参加考试列表">
            <div className="icon"></div>
        </Nav>
        <p className="margin45"></p>
        <FilterList />
        <div className="testlist">   
            <Link to="/stupaperoverview" className="testitem">
                <div className="itempart">
                    ...
                    <span className="fontsize14">
                        ...
                        <p>批改状态：<span className="tip">已批改</span></p>
                    </span>
                </div>
                <div className="itempart">
                </div>					
